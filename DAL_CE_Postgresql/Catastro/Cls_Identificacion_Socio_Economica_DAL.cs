...
namespace DAL_CE_Postgresql.Catastro
{
    public class Cls_Identificacion_Socio_Economica_DAL
    {
        ...
        public void Ingresar_Identificacion_Socio_Economica()
        {
            try
            {
        ...
        public void Consultar_Identificacion_Socio_Economica()
        {
            try
            {
        ...
        public void Modificar_Identificacion_Socio_Economica()
        {
            try
            {
        ...
        public void Eliminar_Identificacion_Socio_Economica()
        {
            try
            {
