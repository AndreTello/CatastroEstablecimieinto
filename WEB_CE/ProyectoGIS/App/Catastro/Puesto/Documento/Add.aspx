...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:TextBox CssClass="form-control mb-4 mt-2" MaxLength="100" runat="server" ID="DOCUMENTO_PUESTO_NOMBRE" />
    ...
    <label>Estado</label>
    <asp:DropDownList CssClass="form-control mb-4 mt-2" runat="server" ID="DOCUMENTO_PUESTO_ESTADO" />
