    ...
    <div id="tabla">
        <div class="table-responsive my-custom-scrollbar table-wrapper-scroll-y">
            <asp:GridView ID="MiTabla" class="table table-sm table-striped table-hover table-bordered table-dark text-center align-middle" runat="server" AutoGenerateColumns="false" >
                <Columns>
                    <asp:BoundField DataField="tipo_producto_id" HeaderText="Id" SortExpression="Id" />
                    <asp:BoundField DataField="tipo_producto_nombre" HeaderText="Nombre" SortExpression="Nombre" />
                    <asp:BoundField DataField="tipo_producto_detalle" HeaderText="Detalle" SortExpression="Detalle" />
                    <asp:BoundField DataField="tipo_producto_observacion" HeaderText="Observación" SortExpression="Observacion" />
                    <asp:BoundField DataField="tipo_producto_estado" HeaderText="Estado" SortExpression="Estado" />
